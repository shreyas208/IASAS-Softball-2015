...
<head>
    ...
    <title>Boys Game Results | IASAS Softball 2015</title>
...
<body>
    ...
    <div class="container" style="background-color: white">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h1 class="page-header">Boys Game Results</h1>
            </div>
        </div>
    </div><!-- /.container -->
    ...
    <script src="https://spreadsheets.google.com/feeds/cells/1nbFx-Eefm0h8lbgwcEPR9Qn6ESji35XBpwqZfk1nKeE/2/public/values?alt=json-in-script&amp;callback=displayContent" type="text/javascript"></script>
