...
<head>
    ...
    <title>Boys Photos | IASAS Softball 2015</title>
...
<body>
    ...
    <div class="container" style="background-color: white">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6">
                <h1 class="page-header">Boys Photos</h1>
            </div>
    ...
    <div class="container" style="background:white">
        ...
        <div class="row"> <!-- full resolution links -->
            <div class="col-lg-12">
                ...
                <a href="https://dragontales.jisedu.or.id/?c=13599&k=af07bbd9db">
                ...
                <?php
                if ($date['mon'] == 4) {
                    if ($date['mday'] > 10) echo '<a href="https://dragontales.jisedu.or.id/?c=13601&k=3d58230ebd"><button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px"><strong>Day 2</strong></button></a>';
                    if ($date['mday'] > 11) echo '<a href="https://dragontales.jisedu.or.id/?c=13604&k=e63ac0c716"><button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px"><strong>Day 3</strong></button></a>';
                }
                ?>
            </div>
        </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function() {
            ...
            $("#content").load(baseurl+"getcol.php?refcol=13599");
            $("#page").load(baseurl+"getpage.php?refcol=13599");
            ...
            $("#liday2").click(function(){
                $("#content").empty();
                $("#content").load(baseurl+"getcol.php?refcol=13601");
                $("#page").load(baseurl+"getpage.php?refcol=13601");
                $("#colls li").removeClass();
                $("#liday2").addClass("active");
            });
            $("#liday3").click(function(){
                $("#content").empty();
                $("#content").load(baseurl+"getcol.php?refcol=13604");
                $("#page").load(baseurl+"getpage.php?refcol=13604");
                $("#colls li").removeClass();
