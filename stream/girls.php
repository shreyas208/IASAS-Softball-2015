...
<head>
    ...
    <title>Girls Stream | IASAS Softball 2015</title>
    ...
    <script type='text/javascript'>
        function reloadContent() {
            $.ajax({
                'async': true,
                'global': false,
                'url': 'https://spreadsheets.google.com/feeds/cells/1nbFx-Eefm0h8lbgwcEPR9Qn6ESji35XBpwqZfk1nKeE/5/public/values?alt=json&amp;callback=displayContent',
                'dataType': "json",
...
<body>
    ...
    <div class="container" style="background-color: white">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Girls Stream</h1>
            </div>
        </div>
    </div><!-- /.container -->
    <div class="container" style="background:white">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                ...
                <a href="https://www.youtube.com/watch?v=GX27N2yPPVU" target="_blank">
                    <button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px">
                        <strong>Day 1</strong>
                    </button>
                </a>
                <a href="https://www.youtube.com/watch?v=hUl8ezoiovQ" target="_blank">
                    <button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px">
                        <strong>Day 2 - 1</strong>
                    </button>
                </a>
                <a href="https://www.youtube.com/watch?v=T0M7XS6lnjM" target="_blank">
                    <button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px">
                        <strong>Day 2 - 2</strong>
                    </button>
                </a>
                <!--<a href="https://www.youtube.com/watch?v=BUUmeOHzUoo" target="_blank">
                    <button type="button" class="btn btn-warning" style="width:84px; margin-bottom:5px; margin-right:10px">
                        <strong>Day 3</strong>
                    </button>
                </a>-->
